...
(module
	...
	(func $test_list
		...
		(call $list_iterate (get_local $list) (funcref "test_list_iterate_each" "index") (i32.const 0))
	...
	(func $test_map
		...
		(call $map_iterate (get_local $map) (funcref "test_map_iterate_each" "index") (i32.const 0))
	)
	...
	(func $test_tree
		...
		(call $tree_iterate (get_local $tree) (funcref "test_tree_iterate_each" "index"))
	)
	...
	(func $test_stream
		...
		(set_local $list (call $list_new))
		(call $list_append (get_local $list) (call $function_new (funcref "test_stream_step_one" "index")))
		(call $list_append (get_local $list) (call $function_new (funcref "test_stream_step_two" "index")))
		(call $list_append (get_local $list) (call $function_new (funcref "test_stream_step_three" "index")))
